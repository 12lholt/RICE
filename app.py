...
with st.form("price_form"):
    ...
    reach = st.number_input("Reach", min_value=0, format="%d", help="The number of people you believe your project will impact within one calendar year.")
    impact = st.number_input("Impact ($)", min_value=0.0, format="%.2f", help="The projected dollar amount of the impact.")
...
if submit_button:
    ...
    if effort <= 0:  # Avoid division by zero
        ...
        price_score = (reach * impact * confidence * passion) / effort
